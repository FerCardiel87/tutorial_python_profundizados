#representaicon de objetos (str, rpre, formart)
#print(dir(object))
...
class Persona:
    ...
    #repr, mas enfocado a los proframadores
    def __repr__(self):
        ...
        #lo implementacion por default llama al metodo rpr

    def __str__(self):
        return f'{self.__class__.__name__}: {self.nombre} {self.apellido}'

    #format su implementacion pro default es str
...
#str de manera automatica el meotodo print llama al metodo str
print(persona1)
#format
print(f'{persona1 }')